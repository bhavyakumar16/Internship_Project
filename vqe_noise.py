...
# Fixed parameter values (theta) representing one "trial" VQE iteration
# -----------------------------
...
plt.title("VQE Ansatz - Noisy (Depolarizing)")
plt.savefig("results/vqe_noisy.png", dpi=300, bbox_inches="tight")
plt.close()

print("\nSaved: results/vqe_ideal.png, results/vqe_noisy.png")