...
# -----------------------------
# Step 3: Calibration - measure all 4 possible basis states to build confusion matrix
# -----------------------------
...
plt.title("VQE Ansatz: Ideal vs Noisy vs MEM-Mitigated")
plt.axhline(y=1.0, color='gray', linestyle='--', linewidth=1)
plt.savefig("results/vqe_mem_comparison.png", dpi=300, bbox_inches="tight")
plt.close()

print("\nSaved chart to results/vqe_mem_comparison.png")