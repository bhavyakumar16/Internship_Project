...
print("Running CDR on QAOA (generating Clifford training circuits + fitting)...")
print("Note: QAOA's RZ/RX rotation gates are non-Clifford, so this is a genuine test of CDR's regression.")
...
print("Training circuits used:      40")
...
plt.title("QAOA: Ideal vs Noisy vs CDR-Mitigated")
plt.axhline(y=ideal_value, color='gray', linestyle='--', linewidth=1)
plt.savefig("results/qaoa_cdr_comparison.png", dpi=300, bbox_inches="tight")
plt.close()

print("\nSaved chart to results/qaoa_cdr_comparison.png")